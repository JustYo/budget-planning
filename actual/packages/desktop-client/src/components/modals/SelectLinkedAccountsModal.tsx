...
export function SelectLinkedAccountsModal(
  ...
  const { externalAccounts, syncSource } = props;
  const requisitionId =
    props.syncSource === 'goCardless' ? props.requisitionId : undefined;
  const sessionId =
    props.syncSource === 'enableBanking' ? props.sessionId : undefined;
