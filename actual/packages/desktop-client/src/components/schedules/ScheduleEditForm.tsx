  ...
  return (
    <>
      <View style={{ display: 'block', overflow: 'scroll', padding: 10 }}>
        ...
        >
          <FormField style={{ flex: 1 }}>
            ...
            <Input
              ...
              onChangeValue={value =>
                dispatch({ type: 'set-field', field: 'payee', value })
              }
            />
          </FormField>
        ...
        >
          <FormLabel title={t('Date')} style={{ margin: 0 }} />
          <Text style={{ color: theme.pageTextLight, fontSize: 12 }}>±</Text>
          <Input
            value={String(fields.dateTolerance ?? 2)}
            style={{ width: 36, padding: '2px 6px', fontSize: 12 }}
            onChangeValue={v => {
              const n = parseInt(v);
              dispatch({
                type: 'set-field',
                field: 'dateTolerance',
                value: Number.isFinite(n) && n >= 0 ? n : 2,
              });
            }}
          />
