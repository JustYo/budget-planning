...
type AccountRowProps = {
  ...
  onSync?: (account: AccountEntity) => void;
  isSyncing?: boolean;
  locale: Locale;
};
  ...
  ({
    ...
    return (
      ...
      >
        ...
        {account.account_sync_source === 'enableBanking' && onSync && (
          <Cell name="sync" plain style={{ paddingRight: '5px' }}>
            <Button onPress={() => onSync(account)} isDisabled={isSyncing}>
