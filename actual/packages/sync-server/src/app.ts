...
import * as emailApp from './app-email';
...
// OAuth2 callback — Enable Banking redirects here after user authorisation.
// Must be at the root so it matches https://importer.ops.quest/eb-callback.
app.get('/eb-callback', enableBankingApp.ebCallbackHandler);
app.use('/gocardless', goCardlessApp.handlers);
app.use('/simplefin', simpleFinApp.handlers);
app.use('/pluggyai', pluggai.handlers);
app.use('/secret', secretApp.handlers);
app.use('/email-settings', emailApp.handlers);
